...
def main(argv: list[str]) -> int:
    ...
    transcript_path = site_dir / 'cli-transcript.txt'
    if transcript_path.exists():
        transcript_text = transcript_path.read_text(encoding='utf-8')
        missing_html.extend(f'cli-transcript:{needle}' for needle in REQUIRED_TRANSCRIPT if needle not in transcript_text)
    else:
        missing_html.append('site/cli-transcript.txt')
